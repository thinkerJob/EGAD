...
class SimpleNet(torch.nn.Module):
    ...
    def _evaluate(self, test_data, scores, segmentations, features, labels_gt, masks_gt):
        ...
        #     dir = path
        # print("need score----------------------------------------------",scores)
        # print("need ImageName----------------------------------",image_paths)
        #image_names = [os.path.basename(path) for path in image_paths]       
        image_names = [path.split("MVTec-AD_test/")[-1] for path in image_paths]
    ...
    def train(self, training_data, test_data):
        ...
        ckpt_path ="results/MVTecAD_Results/simplenet_mvtec/run/models/0/mvtec_screw/ckpt.pth"
        ...
        for i_mepoch in range(self.meta_epochs):
            ...
            #print("need ImageName:",test_data)
